...
test_2d_arrays() {
  ...
  ./npyodin/main.exe ./test_data/floats/half_5x5.npy
  ./npyodin/main.exe ./test_data/floats/longdouble_5x5.npy
  ./npyodin/main.exe ./test_data/floats/single_5x5.npy
}
...
test_1d_arrays() {
  ...
  ./npyodin/main.exe ./test_data/floats/half_5.npy
  ./npyodin/main.exe ./test_data/floats/longdouble_5.npy
  ./npyodin/main.exe ./test_data/floats/single_5.npy
}
